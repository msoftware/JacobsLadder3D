...
#ifndef BASEWALLPAPER_H_
#define BASEWALLPAPER_H_
...
public:
	...
	BaseWallpaper(GLuint identity);
    virtual ~BaseWallpaper();
...
protected:
    ...
    virtual void renderFrameInThread(GLfloat fractionOfPreferedFrame) = 0;

    //Do all your frame iteration/calculation calls here
    virtual void iterateFrameInThread(GLfloat fractionOfPreferedFrame) = 0;
