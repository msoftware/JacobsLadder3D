...
void ObjectBuffers::deriveVerticesFromDimensions(Dimension *dimens)
{
	...
	END_TIMER(Timer::DERIVE_VERTICES)
...
void ObjectBuffers::deriveBackground()
{
	...
	END_TIMER(Timer::DERIVE_BACKGROUND)
...
void ObjectBuffers::deriveBackgroundSlice(GLuint z_near, GLuint z_far, corner *backgroundSegment)
{
	...
	color_array **colorArrayTopLeft = colorSet->distancePaints[0][Y_BLOCKS];
	color_array **colorArrayTopRight = colorSet->distancePaints[X_BLOCKS][Y_BLOCKS];
	color_array **colorArrayBottomLeft = colorSet->distancePaints[0][0];
	color_array **colorArrayBottomRight = colorSet->distancePaints[X_BLOCKS][0];

	color_array **colorArrayTopMiddle = colorSet->distancePaints[(GLuint)X_BLOCKS_MID][Y_BLOCKS];
	color_array **colorArrayRightMiddle = colorSet->distancePaints[X_BLOCKS][(GLuint)Y_BLOCKS_MID];
	color_array **colorArrayLeftMiddle = colorSet->distancePaints[0][(GLuint)Y_BLOCKS_MID];
	color_array **colorArrayBottomMiddle = colorSet->distancePaints[(GLuint)X_BLOCKS_MID][0];
	...
	for(GLuint z = 0; z < Z_BLOCKS; z++){
		...
		for(GLuint x = 0; x < X_BLOCKS; x++){
			...
			for(GLuint y = 0; y < Y_BLOCKS; y++){
				...
				color_array* cubeColorArray = colorSet->distancePaints[(GLuint)x][(GLuint)y][z];
